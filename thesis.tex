...
analysis. This is then used to successfully study four stars with varying spectral type; the Sun,
one hotter than the Sun, and two cooler. Due to lack of NIR spectra, I choose to analyse some
synthetic spectra as well which is also presented in Chapter 4.
