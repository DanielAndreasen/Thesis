...
fly like SME \citep{...}, or using a pre-calculated grid. By analysing the
$\chi^2$ the synthetic spectrum that best match the observed spectrum can be
...
transistions. The EWs are measured (see \sref{sec:measureEW}) for all these
...
mean abundance of the \ion{Fe}{I} lines is equal to the unput
