...
\begin{itemize}
  ...
  \item {\bf The ionization state}, e.g. \ion{Fe}{I} describes iron in its atomic form, while
...
wavelength, and m\angstrom for the EW.
...
$\SI{53.9}{m\angstrom}$ for the \ion{Fe}{I} and \ion{Fe}{II} line respectively.
...
not be measured and is thus discarded, 2) the EW of the line is weak (below 5 m\angstrom) to be
reliable, 3) the EW of the line is too strong ( above 150 m\angstrom) and the line show non-linear
