...
\unfinished{Probably remove this section or rewrite it}
...
different codes that does this. Here the \code{MOOG} code us used \citep{Sneden1973}. This code has
different drivers, only some are used here.
\unfinished{Expand this and descripe how it works in more details. Maybe move it down under EW section}
\begin{itemize}
