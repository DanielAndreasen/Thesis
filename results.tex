...
characteristics can be found in \tref{tab:stars}. \hl{A plot of the spectra of the three stars
analysed (not including the Sun) in this chapter is shown in} \fref{fig:NIRspectra}. More details
