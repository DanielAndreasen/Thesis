...
combined. The success of the different methods can be seen in \fref{fig:detectionTypes}, Where all
...
above in} \sref{sec:transitMethod}.
...
mass exoplanets as seen in \fref{fig:exoplanetMass} and the regime of Earth-mass exoplanets have
...
parameters can be seen in} \tref{tab:standardErrors}. \hl{The parameters are from
